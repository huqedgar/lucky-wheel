...
function Calendar({
  ...
  const dateFnsLocale = locale ?? (appLocale === "vi" ? vi : enUS);
  ...
  return (
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) => date.toLocaleString(appLocale, { month: "long" }),
        ...formatters,
      }}
      classNames={{
      ...
      components={{
        ...
        DayButton: ({ ...props }) => <CalendarDayButton locale={dateFnsLocale} {...props} />,
